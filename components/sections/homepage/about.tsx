      ...
      <div className="flex min-h-128 w-full py-12">
        ...
        <div className="w-1/2 flex items-center bg-transparent px-10 lg:px-14">
          <div className="max-w-xl text-left space-y-10">
            ...
            <div className="flex">
              <button className="btn-primary bg-transparent outline-gray-800 outline-1 text-gray-800 cursor-pointer">Learn More</button>
            </div>
          </div>
        </div>

        {/* Right side - Image */}
        <div className="relative w-3xl aspect-9/6 rounded-lg shadow-2xl overflow-hidden">
          <Image
            src="/nz1.avif"
